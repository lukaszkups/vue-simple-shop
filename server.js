...
const data = [
  ...
  { id: 2, name: 'Volleyball ball', available: false, price: 17.90, image: 'https://images.pexels.com/photos/2471259/pexels-photo-2471259.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500', description_short: 'Handy volleyball ball. Ut molestie a, ultricies porta urna. Vestibulum commodo volutpat a, convallis ac, laoreet enim.', description_long: 'Volleyball perfect for beach tournaments or just for fun.' },
